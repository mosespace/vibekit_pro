...
export function CpuArchitecture({
  ...
  return (
    <svg
      className={cn("text-[color:var(--text-tertiary)]", className)}
      width={width}
      height={height}
      viewBox="0 0 200 100"
      aria-hidden="true"
    >
      ...
      {/* Animated lights traveling along paths */}
      ...
      <g>
        ...
        <rect x="85" y="40" width="30" height="20" rx="2" fill="#0E0E0E" filter="url(#cpu-light-shadow)" />
        <text
          x={100}
          y="52.5"
          textAnchor="middle"
          fontSize="6.5"
          fill={animateText ? "url(#cpu-text-gradient)" : "#FAFAFA"}
          fontWeight="700"
      ...
      <defs>
        ...
        <filter id="cpu-light-shadow" x="-50%" y="-50%" width="200%" height="200%">
          <feDropShadow dx="1" dy="1.5" stdDeviation="1" floodColor="black" floodOpacity="0.3" />
        </filter>
        ...
        >
          <circle cx="5" cy="5" r="2" fill="#0E0E0E" stroke="#2D2D2D" strokeWidth="0.5">
        ...
        <linearGradient id="cpu-connection-gradient" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#5A5A56" />
